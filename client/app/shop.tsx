           ...
           ListEmptyComponent={
            !loading && (
              ...
              justify-center py-20'>
                  <Text className='text-secondary'>No
                    products found</Text>
              </View>
            )
           }
