...
export default function Cart() {
  ...
  const { cartItems, cartTotal, removeFromCart, 
        ...
        shadow-sm'>
          {/* SubTotal */}
           <View className='flex-row justify-between mb-2'>
            ...
            {/* Checkout button */}
            <TouchableOpacity className='bg-primary py-4
            rounded-full items-center' onPress={()=>router.push('/checkout')}>
              <Text className='text-white font-bold
              text-base'>Checkout</Text>
            </TouchableOpacity>
        </View>
        </>
       ) : (
