...
export default function Header({title, showBack, showSearch, showCart, showMenu,
    showLogo } : HeaderProps) {
        const router= useRouter()
        const { itemCount } = {itemCount: 6} // Example value, in a real app this would be dynamic
  return (
